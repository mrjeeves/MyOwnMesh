...
export function createPeerSessionTestHarness({ rpc, writer, onRecord, events, durationMs = 5_000 }) {
  ...
  const session = new PeerSession(
    { durationMs },
    { onRecord },
    { token: TEST_SESSION, rpc, writer, child, events },
  );
